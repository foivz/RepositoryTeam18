...
namespace VelproDesktop
{
    public partial class BrisiKorisnika : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 't18_DBDataSet8.Korisnici' table. You can move, or remove it, as needed.
            this.korisniciTableAdapter.Fill(this.t18_DBDataSet8.Korisnici);
        ...
        private void fillByToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.korisniciTableAdapter.FillBy(this.t18_DBDataSet8.Korisnici);
            }
