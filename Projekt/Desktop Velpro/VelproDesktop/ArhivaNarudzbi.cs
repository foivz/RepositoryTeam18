...
namespace VelproDesktop
{
    public partial class ArhivaNarudzbi : Form
    {
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            //sqlUpit = "SELECT sn.Kolicina AS [Naručena količina], a.Naziv_artikla AS Naziv, a.Cijena_artikla AS Cijena, a.Dostupna_kolicina AS [Dostupna količina] FROM Stavke_narudzbe sn INNER JOIN Artikli a ON sn.ID_artikla=a.ID_artikla WHERE sn.ID_narudzbenice=" + ID_narudzbe + "";

            //sqlOdgovor = Baza.SelectUpit(sqlUpit);
